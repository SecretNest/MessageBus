...
{
    [TestClass]
    public class AsyncCallExecuteOnce
    {
        [TestMethod]
        public async Task TestMethodAsync()
        {
            ...
            var result1000BAsync = await bus.ExecuteOnceWithReturnAsync("ArgumentMatching", 1500, new MessageBusPublisherOptions<int, int>(defaultReturnValue: 5));
            ...
            Assert.AreEqual(1000, result1000BAsync);
