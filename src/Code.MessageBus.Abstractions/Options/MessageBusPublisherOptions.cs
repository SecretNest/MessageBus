...
namespace SecretNest.MessageBus.Options
{
    ...
    public class MessageBusPublisherOptions<TParameter> : MessageBusPublisherOptionsBase
    {
        ...
        /// </summary>
        /// <remarks>If presents, the callback is invoked to convert the argument the when publisher executing. Default value is <see langword="null"/>.</remarks>
    ...
    public class MessageBusPublisherOptions<TParameter, TReturn> : MessageBusPublisherOptions<TParameter>
    {
        ...
        /// </summary>
        /// <remarks>If presents, the callback is invoked to convert the return value before publisher returning. The value provided by <see cref="DefaultReturnValue"/> is exempted from being converted by this callback. Default value is <see langword="null"/>.</remarks>
